...
export default function FractalHaze({
    children,
    className = "",
    speed = 1.8,
    barWidth = 27.0,
    ...
    useEffect(() => {
        let renderer: any, program: any, mesh: any, startTime: number;
    ...
    return (
        <div className={`${styles.wrapper} ${className}`.trim()}>
            <canvas
                ref={canvasRef}
                className={styles["fractal-haze-canvas"]}
            />
            {children && (
