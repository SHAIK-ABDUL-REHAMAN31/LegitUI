...
export const HoverRevealCard: React.FC<HoverRevealCardProps> = ({
  title = "The Weeknd",
  subtitle = "STARBOY",
  description = "Experience the electric energy of Starboy, a cinematic and auditory masterpiece.",
  imageSrc = "https://images.unsplash.com/photo-1614613535308-eb5fbd3d2c17?q=80&w=800&auto=format&fit=crop",
  buttonText = "Play Now",
  perspective = 1000,
  hoverDelay = 0,
  className = ""
