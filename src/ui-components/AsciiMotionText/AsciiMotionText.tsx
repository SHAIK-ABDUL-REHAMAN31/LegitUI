...
interface AsciiParticleSystemProps {
  text?: string;
  fontSize?: number;
  density?: number;
  mouseRadius?: number;
...
const AsciiParticleSystem: React.FC<AsciiParticleSystemProps> = ({
  text = "MOTION",
  fontSize = 1.5,
  density = 128,
  mouseRadius = 0.5,
...
export const AsciiMotionText: React.FC<AsciiParticleSystemProps> = (props) => {
  return (
