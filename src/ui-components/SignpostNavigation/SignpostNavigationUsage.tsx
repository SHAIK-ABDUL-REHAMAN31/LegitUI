...
export default function SignpostNavigationUsage() {
  ...
  return (
    <div style={{ width: "100%", display: "flex", justifyContent: "center", background: "#f8f9fa", height: "100%", alignItems: "center" }}>
