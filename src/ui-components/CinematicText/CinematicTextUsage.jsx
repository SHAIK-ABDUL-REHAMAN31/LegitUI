...
export const CinematicTextUsage = () => {
    ...
    return (<div style={{ padding: "2rem", fontFamily: "sans-serif", backgroundColor: "#ffffffff", color: "#fff", minHeight: "150vh" }}>
            ...
            <CinematicText text={text} subtitle={subtitle} activeColor={activeColor} inactiveColor={inactiveColor} fontSize={fontSize}/>
        </div>);
};
