...
const ScaleBlur = ({ text = "Build. Ship. Scale.", }) => {
    ...
    return (<section ref={sectionRef} className={styles.container}>
            <h2 className={styles.title}>
                {words.map((word, index) => (<span key={index} ref={addWordRef} className={styles.word}>
                        {word}
                    </span>))}
            </h2>
