...
interface Premium3DCursorUsageProps {
  size?: number;
  lag?: number;
  baseColor?: string;
...
export default function Premium3DCursorUsage(props: Premium3DCursorUsageProps) {
  ...
  return (
    <div
      className="absolute inset-0 bg-[#080c18] flex flex-col items-center justify-center font-sans text-white overflow-hidden select-none"
      style={{ cursor: isHovered ? "none" : "auto" }} // Hide the original browser cursor within the preview area!
