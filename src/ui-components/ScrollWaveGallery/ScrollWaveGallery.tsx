...
export interface ScrollWaveGalleryProps {
    images?: string[];
    className?: string;
    /** How many times the gallery loops over the scroll distance */
    loops?: number;
    /** Amplitude of the wave curvature */
    waveAmplitude?: number;
}

function Card({ index, total, url, loops, waveAmplitude }: any) {
...
function Gallery({ images, loops, waveAmplitude }: any) {
    return (
        <>
