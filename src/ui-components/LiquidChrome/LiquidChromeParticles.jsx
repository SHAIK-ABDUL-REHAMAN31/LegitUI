...
function Particles({ particleCount, baseColor, highlightColor, glowColor, speed, particleSize, }) {
...
export default function LiquidChromeParticles({ className = "", particleCount = 40000, baseColor = "#05050a", highlightColor = "#ffffff", glowColor = "#6699ff", speed = 0.3, particleSize = 12.0, background = "#050505", }) {
    return (<div className={`${styles.container} ${className}`} style={{ backgroundColor: background }}>
            <Canvas camera={{ position: [0, 0, 5], fov: 75 }} dpr={[1, 2]}>
                <Particles particleCount={particleCount} baseColor={baseColor} highlightColor={highlightColor} glowColor={glowColor} speed={speed} particleSize={particleSize}/>
            </Canvas>
        </div>);
}
