...
// ════════════════════════════════════════════════════════
// CurvedTypography — Flowing Text on SVG Paths
// Supports: circle, wave, spiral with subtle morphing
// ════════════════════════════════════════════════════════

interface CurvedTypographyProps {
  /** The text string to flow along the path */
  text?: string;
  /** Shape type of the curve */
  type?: "circle" | "wave" | "spiral";
  ...
  /** Toggle visibility of the guiding SVG path */
  showPath?: boolean;
  /** Color of the guiding SVG path */
  pathColor?: string;
  /** Speed of the subtle shape morphing (in seconds) */
  morphSpeed?: number;
...
const CurvedTypography: React.FC<CurvedTypographyProps> = ({
  text = "CREATIVE TECHNOLOGY · EXPERIMENTAL TYPOGRAPHY · WEB DEVELOPMENT · ",
  type = "wave",
  speed = 10,
  textColor = "#ffffff",
  fontSize = 20,
