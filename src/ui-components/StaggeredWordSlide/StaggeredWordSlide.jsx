...
const StaggeredWordSlide = ({ 
    ...
    return (<section ref={containerRef} className={styles.container} style={{ backgroundColor }}>
      <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }} className={styles.wrapper}>
        <h2 className={styles.heading} style={{ color: textColor, fontSize }}>
