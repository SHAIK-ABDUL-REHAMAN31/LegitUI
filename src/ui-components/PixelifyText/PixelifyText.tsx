 ...
 */
const PixelifyText: React.FC<PixelifyTextProps> = ({
    text = "PIXEL ART",
    gridSize = 4,
    color = "#000000ff",
    fontSize = 120,
    ...
    useEffect(() => {
        ...
        const init = async () => {
            ...
            const activePixels: { x: number, y: number, alpha: number, scale: number, targetX: number, targetY: number }[] = [];
