...
const TextRoller: React.FC<TextRollerProps> = ({
  words = "APPLICATIONS,ARCHITECTURE,PERFORMANCE,SCALABILITY,SECURITY,DEPLOYMENT,OPTIMIZATION,TESTING,APIs,INTEGRATION",
  speed = 1.0,
  className = "",
  ...
  useEffect(() => {
    ...
    let timerRef: gsap.core.Tween | null = null;
    ...
    const animateNext = () => {
      ...
      let innerText: HTMLElement | null = null;

      if (incomingItem) {
        innerText = incomingItem.querySelector('.inner-text') as HTMLElement;
      }
        ...
        <div ref={listRef} className={styles.list}>
          {tripled.map((word, i) => (
            <div
              ...
              style={{ height: ITEM_HEIGHT, fontSize }}
            >
