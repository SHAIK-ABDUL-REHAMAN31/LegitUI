...
const HalftoneEyes = ({ eyeSize = 220, gridSpacing = 8, maxOffset = 35, lerpSpeed = 0.08, theme = 'sapphire', irisColor = '#3b82f6', scleraColor = '#fdfaf6', pupilRadius = 32, irisRadius = 65, scleraRadius = 100, backgroundColor = '#000000', eyeDistance = 40, ambientDrift = true, className = '', }) => {
    ...
    useEffect(() => {
        ...
        const updateGaze = (canvas, gaze, time) => {
    ...
    return (<div className={`${styles.container} ${className}`}>
      <div className={styles.eyesWrapper} style={{ gap: `${eyeDistance}px` }}>
        <canvas ref={leftCanvasRef} width={eyeSize} height={eyeSize} className={styles.eyeCanvas} style={{ width: `${eyeSize}px`, height: `${eyeSize}px` }}/>
        <canvas ref={rightCanvasRef} width={eyeSize} height={eyeSize} className={styles.eyeCanvas} style={{ width: `${eyeSize}px`, height: `${eyeSize}px` }}/>
      </div>
    </div>);
};
