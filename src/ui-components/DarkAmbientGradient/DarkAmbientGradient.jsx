...
export default function DarkAmbientGradient({ className = "", background = "#010008", color1 = "#7c3aed", color2 = "#db2777", color3 = "#2563eb", color4 = "#06b6d4", speed = 0.25, intensity = 0.9, distortion = 0.5, children, }) {
