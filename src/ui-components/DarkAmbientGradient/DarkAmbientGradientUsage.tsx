...
import DarkAmbientGradient, { DarkAmbientGradientProps } from "./DarkAmbientGradient";

export default function DarkAmbientGradientUsage(props: Partial<DarkAmbientGradientProps>) {
