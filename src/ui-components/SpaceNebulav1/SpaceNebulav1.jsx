...
`;
export default function SpaceNebulav1({ className = "", speed = 1.0, starCount = 1200, warpFreq = 1.0, warpAmp = 1.0, waveDirX = 1.0, waveDirY = 1.0, color1 = "#ffb4f0", color2 = "#c8ffff", baseColor = "#03020e", children, }) {
