...
import { Home, User, Settings, Mail, Bell, Search, Layout } from "lucide-react";
...
export default function MagneticDockUsage() {
  ...
  return (
    <div style={{ position: "relative", width: "100%", height: "400px", background: "#050505", borderRadius: "12px", overflow: "hidden" }}>
