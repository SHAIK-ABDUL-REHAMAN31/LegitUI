                ...
                <div className={styles.innerCard}>
                    ...
                    <div className={styles.toggleArea}>
                        <button
                            ...
                            className={`${styles.toggleTrack} ${isActive ? styles.toggleTrackActive : styles.toggleTrackInactive}`}
                            aria-label="Toggle card"
                        >
                            <div
                                className={`${styles.toggleThumb} ${isActive ? styles.toggleThumbActive : styles.toggleThumbInactive}`}
                            />
                        </button>
                    </div>
