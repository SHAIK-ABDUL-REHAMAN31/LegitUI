...
interface ScrollSnakeTransitionProps {
  /** Custom content for Section 1. If not provided, a default hero is shown. */
  section1Content?: React.ReactNode;
  /** Custom content for Section 2. If not provided, a default massive text layout is shown. */
  section2Content?: React.ReactNode;
  /** Color of the snake curve path. @default '#2563eb' */
  snakeColor?: string;
  /** Thickness of the snake curve path in pixels. @default 75 */
  strokeWidth?: number;
  /** Animation duration in seconds for drawing the snake. @default 2.2 */
...
const ScrollSnakeTransition: React.FC<ScrollSnakeTransitionProps> = ({
  section1Content,
  section2Content,
  snakeColor = '#2563eb',
  strokeWidth = 75,
    ...
    >
      ...
      <div
        className={`${styles.section1} ${
          activeSection === 2 ? styles.section1Hidden : ''
        }`}
      >
        {section1Content ? (
          section1Content
      ...
      <div
        ...
        className={`${styles.section2} ${
          activeSection === 2 ? styles.section2Visible : ''
        }`}
      >
        {activeSection === 2 && (
          section2Content ? (
