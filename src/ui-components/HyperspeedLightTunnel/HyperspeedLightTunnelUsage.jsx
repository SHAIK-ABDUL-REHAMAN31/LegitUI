...
import HyperspeedLightTunnel from "./HyperspeedLightTunnel";
export default function HyperspeedLightTunnelUsage(props) {
    ...
    return (<div style={{
      ...
      <HyperspeedLightTunnel background="#05000a" coreColor="#ffaa00" streakColor1="#ff007f" streakColor2="#7000ff" streakColor3="#00f0ff" speed={1.5} density={30.0} curve={1.5} {...props}>
